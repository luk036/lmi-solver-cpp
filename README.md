...
[![Actions Status](https://github.com/luk036/lmi-solver-cpp/workflows/Style/badge.svg)](https://github.com/luk036/lmi-solver-cpp/actions)
[![Actions Status](https://github.com/luk036/lmi-solver-cpp/workflows/Install/badge.svg)](https://github.com/luk036/lmi-solver-cpp/actions)
[![codecov](https://codecov.io/gh/luk036/lmi-solver-cpp/branch/master/graph/badge.svg)](https://codecov.io/gh/luk036/lmi-solver-cpp)
...
- Replace all occurrences of "LmiSolver" in the relevant CMakeLists.txt with the name of your project
  ...
  - Remember to rename the `include/lmisolver` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
The documentation is automatically built and [published](https://luk036.github.io/lmi-solver-cpp) whenever a [GitHub Release](https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository) is created.
